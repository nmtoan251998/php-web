    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
            <li class="nav-item active">
                <a class="nav-link" href="/view/admin/index.php">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/view/admin/page/manageBlog.php">Manage blog</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/view/admin/page/newBlog.php">New blog</a>
            </li>
        </ul>
    </div>
